...
export const CONFIG = {
    ...
    CREATOR_RISK_PARSED_TX_LIMIT: Number(process.env.CREATOR_RISK_PARSED_TX_LIMIT || 20),
    CREATOR_RISK_PARSED_TX_CONCURRENCY: Number(process.env.CREATOR_RISK_PARSED_TX_CONCURRENCY || 4),
    ...
    CREATOR_RISK_RELAY_SIG_LIMIT: Number(process.env.CREATOR_RISK_RELAY_SIG_LIMIT || 4),
    CREATOR_RISK_RELAY_PARSED_TX_LIMIT: Number(process.env.CREATOR_RISK_RELAY_PARSED_TX_LIMIT || 3),
    ...
    CREATOR_RISK_DIRECT_AMM_REENTRY_SIG_LIMIT: Number(process.env.CREATOR_RISK_DIRECT_AMM_REENTRY_SIG_LIMIT || 4),
    ...
    CREATOR_RISK_PRECREATE_BURST_SIG_LIMIT: Number(process.env.CREATOR_RISK_PRECREATE_BURST_SIG_LIMIT || 60),
    CREATOR_RISK_PRECREATE_BURST_PARSED_TX_LIMIT: Number(process.env.CREATOR_RISK_PRECREATE_BURST_PARSED_TX_LIMIT || 25),
    ...
    CREATOR_RISK_RATE_LIMIT_RETRIES: Number(process.env.CREATOR_RISK_RATE_LIMIT_RETRIES || 1),
    CREATOR_RISK_RATE_LIMIT_RETRY_BASE_MS: Number(process.env.CREATOR_RISK_RATE_LIMIT_RETRY_BASE_MS || 600),
