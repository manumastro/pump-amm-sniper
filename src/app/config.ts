...
export const CONFIG = {
    ...
    SHADOW_AUDIT_CREATOR_UNIQUE_COUNTERPARTIES_ENABLED:
        process.env.SHADOW_AUDIT_CREATOR_UNIQUE_COUNTERPARTIES_ENABLED !== "false",
    SHADOW_AUDIT_TOP10_ENABLED: process.env.SHADOW_AUDIT_TOP10_ENABLED !== "false",
    SHADOW_AUDIT_TOP10_MIN_PCT: Number(process.env.SHADOW_AUDIT_TOP10_MIN_PCT || 30),
    SHADOW_AUDIT_TOP10_MAX_PCT: Number(process.env.SHADOW_AUDIT_TOP10_MAX_PCT || 40),
} as const;
