...
**IMPORTANT**: This file must be kept in sync with `CLAUDE.md` and `AGENTS.md`. Any updates to agent instructions must be made to ALL THREE files simultaneously.
